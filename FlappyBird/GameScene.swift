...
class GameScene: SKScene, SKPhysicsContactDelegate{
    ...
    override func didMoveToView(view: SKView) {
        ...
        for i in 0..<Int(2.0 + self.frame.size.width / ( groundTexture.size().width * 2.0 )){
            ...
            sprite.setScale(2.0)
            sprite.position = CGPoint(x: j * sprite.size.width, y: sprite.size.height / 2.0)
        ...
        for i in 0..<Int(2.0 + self.frame.size.width / ( groundTexture.size().width * 2.0 )){
            ...
            sprite.setScale(2.0)
            sprite.zPosition = -20
            sprite.position = CGPoint(x: j * sprite.size.width, y: sprite.size.height / 2.0 + groundTexture.size().height * 2.0)
